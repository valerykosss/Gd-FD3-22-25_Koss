...
import { getAlbums, getComments, getPhotos, getPosts, getTodos, getUsers } from "../api/jsonplaceholder";
...
export default function TodosPageFilterVariant2() {
    ...
    useEffect(() => {
        ...
        //3.1.1 getTodos() вынесеснна из api -> jsonplaceholder.ts
         async function load() {
            const data = await getTodos();
            ...
            console.log('dataPhotos', dataUsers);
        }
        load();

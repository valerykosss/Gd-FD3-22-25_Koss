...
function four(array: number[]) : number {
    return array[0];
}

function five(array: string[]) : string {
    return array[0];
}

function six(array: (string | number)[]) : string | number {
    return array[0];
}

function seven<T>(array: T[]) : T {
    return array[0];
}

seven([1,2,3]);
seven(['','hello','world']);
seven<string>(['','hello','world']);